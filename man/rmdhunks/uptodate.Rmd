...
* You could use GitHub actions. Refer to GitHub actions docs <https://github.com/features/actions>, and to the example workflow provided in this package.

```r
dir.create(".github")
dir.create(file.path(".github", "workflows"))
file.copy(system.file("templates", "codemeta-github-actions.yml", package = "codemetar"),
