...
frame <- '{
  "@context": "https://raw.githubusercontent.com/codemeta/codemeta/master/codemeta-v2.jsonld",
  "author": {"affiliation": {"@default": "@null"} }
}'
...
```{r}
meta <-
  jsonld_frame(codemeta, '{"@context": "https://raw.githubusercontent.com/codemeta/codemeta/master/codemeta-v2.jsonld"}') %>% 
  fromJSON(codemeta, simplifyVector = FALSE) %>%  
  getElement("@graph") %>% getElement(1)    

## above is same as compacting:
#jsonld_compact(codeemta, "https://raw.githubusercontent.com/codemeta/codemeta/master/codemeta-v2.jsonld") %>% 
#  fromJSON(codemeta, simplifyVector = FALSE)
