...
endpoint <- oauth_endpoint(NULL, "authorize", "token", base_url = "https://orcid.org/oauth/")
...
req <- GET("https://pub.sandbox.orcid.org/v2.0/search/?q=family-name:Sanchez", orcid_token)
stop_for_status(req)
content(req)

# OR:
req <- with_config(orcid_token, GET("https://pub.sandbox.orcid.org/v2.0/search/?q=family-name:Sanchez"))
stop_for_status(req)
content(req)
